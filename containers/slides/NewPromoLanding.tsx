    ...
    >
      ...
      */}
      <Box
        sx={{
          position: "absolute",
          top: { xs: "38%", sm: "38%", md: "37%", lg: "36%" },
          right: { xs: "4%", sm: "3%", md: "5%", lg: "6%" },
          width: { xs: "90%", sm: "420px", md: "440px" },
          display: "flex",
          flexDirection: "column",
          gap: { xs: 2, sm: 2.25 },
          pointerEvents: "auto",
      ...
      >
        ...
        <Button onClick={handleBuyProducts} sx={neonButtonSx}>
          <Box sx={CTA_ICON_BOX}>
            <Icon icon="mdi:cart-outline" width={44} height={44} />
          </Box>
          <Box sx={ctaTextColSx}>
            <Typography
              sx={{
        ...
        <Button onClick={handleSpinWheelClick} sx={neonButtonSx}>
          <Box sx={CTA_ICON_BOX}>
            <Icon icon="mdi:ferris-wheel" width={44} height={44} />
          </Box>
          <Box sx={ctaTextColSx}>
            <Typography
              sx={{
